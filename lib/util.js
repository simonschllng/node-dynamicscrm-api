...
var Util = function (settings) {
    ...
    if (settings.defaultUrlSuffix && typeof settings.defaultUrlSuffix !== "boolean") throw new Error("'settings.defaultUrlSuffix' property must be a boolean.");
    ...
    var defaultUrlSuffix = settings.defaultUrlSuffix === false ? "" : ".api.crm.dynamics.com" ,
        ...
        organizationServiceEndpoint = (settings.useHttp ? "http://" : "https://") + hostname + organizationPath,
